# Histórico dos Projetos (Visão Macro)

Formatos:
- 🧩 Tipo: Automação / Dados / Web / API / Limpador de dataset...
- ⏱️ Duração: Tempo aproximado gasto
- 🛠️ Skills usadas: Pandas, Requests, Selenium, Regex, Plot, etc.
- ⭐ O que tem de mais forte: 1 frase só
